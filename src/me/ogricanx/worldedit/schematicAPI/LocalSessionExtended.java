...
/**
 * This is the Complete WorldEdit LocalSeasion.class
 * Just added some Features, for easyer Usage autside of WorldEdit.
 * 
 * https://github.com/sk89q/WorldEdit/blob/master/worldedit-core/src/main/java/com/sk89q/worldedit/LocalSession.java
 */

@SuppressWarnings("deprecation")
public class LocalSessionExtended {
     ...
     */
    public LocalSessionExtended(@Nullable LocalConfiguration config) {
        this.config = config;
    }
     ...
     */
    public EditSession undo(@Nullable BlockBag newBlockBag) {
        --historyPointer;
        if (historyPointer >= 0) {
     ...
     */
    public EditSession redo(@Nullable BlockBag newBlockBag) {
...
//    }
	...
	/**
	 * @return the mAX_HISTORY_SIZE
	 */
	public static int getMAX_HISTORY_SIZE() {
		return MAX_HISTORY_SIZE;
	}

	/**
	 * @param mAX_HISTORY_SIZE the mAX_HISTORY_SIZE to set
	 */
	public static void setMAX_HISTORY_SIZE(int mAX_HISTORY_SIZE) {
	 ...
	 */
	public void setConfig(LocalConfiguration config) {
		this.config = config;
	}
	...
	/**
	 * @param placeAtPos1 the placeAtPos1 to set
	 */
	 ...
	 * @return the history
	 */
	public LinkedList<EditSession> getHistory() {
		return history;
	}
	 ...
	 */
	public void setHistory(LinkedList<EditSession> history) {
		this.history = history;
	}

	/**
	 * @return the historyPointer
	 */
	...
	/**
	 * @param historyPointer the historyPointer to set
	 */
	...
	/**
	 * @return the pickaxeMode
	 */
	public BlockTool getPickaxeMode() {
		return pickaxeMode;
	}

	/**
	 * @param pickaxeMode the pickaxeMode to set
	 */
	public void setPickaxeMode(BlockTool pickaxeMode) {
		this.pickaxeMode = pickaxeMode;
	}
	 ...
	 */
	public void setTools(Map<Integer, Tool> tools) {
		this.tools = tools;
	}

	/**
	 * @return the maxBlocksChanged
	 */
	...
	/**
	 * @param maxBlocksChanged the maxBlocksChanged to set
	 */
	...
	/**
	 * @return the hasCUISupport
	 */
	public boolean isHasCUISupport() {
		return hasCUISupport;
	}

	/**
	 * @param hasCUISupport the hasCUISupport to set
	 */
	public void setHasCUISupport(boolean hasCUISupport) {
		this.hasCUISupport = hasCUISupport;
	}

	/**
	 * @return the cuiVersion
	 */
	public int getCuiVersion() {
		return cuiVersion;
	}
	...
	/**
	 * @param cuiVersion the cuiVersion to set
	 */
	public void setCuiVersion(int cuiVersion) {
		this.cuiVersion = cuiVersion;
	}
	 ...
	 */
	public RegionSelectorType getDefaultSelector() {
		return defaultSelector;
	}
	 ...
	 */
	public void setDefaultSelector(RegionSelectorType defaultSelector) {
		this.defaultSelector = defaultSelector;
	}
	...
	/**
	 * @param superPickaxe the superPickaxe to set
	 */
